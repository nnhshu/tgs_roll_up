...
class CalculateDailyAccounting
{
    ...
    /**
     * Execute accounting calculation for type 7 (thu) and 8 (chi)
     *
    ...
    public function execute(int $blogId, string $date): array
    {
        ...
        return $this->blogContext->executeInBlog($blogId, function() use ($blogId, $date) {
            // Logic:
            // Type 7 (thu): total_income += local_ledger_total_amount
            // Type 8 (chi): total_expense += local_ledger_total_amount
